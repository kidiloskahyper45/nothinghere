...
from Angelina import (DEV_USERS, GBAN_LOGS, OWNER_ID, STRICT_GBAN, SUDO_USERS,
                      SUPPORT_USERS, WHITELIST_USERS, dispatcher)
from Angelina.modules.helper_funcs.chat_status import is_user_admin, user_admin
...
user_id, reason = extract_user_and_text(message, args)
    ...
    if int(user_id) in SUDO_USERS:
        message.reply_text("Yay There is Nothing I Can Do Because This User is Scorpion And I Scare With Scorpionsð«")
        return
